...
<StepList steps={[
  { number: "01", title: "Give it a role", description: "Define who the AI is, what it optimizes for, and where its authority ends." },
  ...
  { number: "04", title: "Give it judgment", description: "Train it to bring you structured analysis, not just confident answers." },
...
<Progression levels={[
  ...
  { label: "Layer 3", title: "Playbooks", description: "Repeatable workflows your COO runs on demand. \"Draft a client proposal.\" \"Run the weekly review.\" \"Prepare the investor update.\" Loaded when needed, not all the time.", analogy: "Documented workflows in notes system, or custom commands" },
...
The sentence that made this work: *"Document what actually happened, not what should have happened. If a decision was messy or we changed direction, say so. Future sessions need the truth, not the polished version."* One sentence. Changed how every documentation task gets handled.
</Callout>
...
<WeekCycle weeks={[
  ...
  { week: "Week 3", focus: "Ops", description: "Automate. Document. Streamline." },

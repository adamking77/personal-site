...
const $$Forgot$1 = createComponent(($$result, $$props, $$slots) => {
...
` })} ` })} ${renderComponent($$result, "Wrapper", $$Wrapper, { "variant": "standard", "class": "py-12" }, { "default": ($$result2) => renderTemplate` <form class="border-t dark:border-white/10 border-black/10 pt-2" action="#" method="POST"> <div class="grid grid-cols-1 gap-2 md:grid-cols-3"> <div class="md:col-span-2"> <label for="email" class="sr-only">Email address</label> <div> <input id="email" name="email" type="email" autocomplete="email" placeholder="email@example.com" aria-placeholder="email@example.com" required class="block w-full rounded-lg border h-8 dark:bg-white/5 border-black/10 px-4 py-2 font-spline text-sm font-medium text-zinc-800 placeholder-zinc-400 focus:border-zinc-500 focus:outline-none focus:ring-2 lg:px-6 focus:ring-zinc-600/50 disabled:opacity-50"> </div> </div> ${renderComponent($$result2, "Button", $$Button, { "size": "medium", "variant": "primary" }, { "default": ($$result3) => renderTemplate`Submit` })} </div> </form> ` })} </section>`;
}, "/Users/adamking/claude-code-projects/ak-site/src/components/forms/Forgot.astro", void 0);

const $$Forgot = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Forgot", $$Forgot$1, {})} ` })}`;
}, "/Users/adamking/claude-code-projects/ak-site/src/pages/forms/forgot.astro", void 0);

const $$file = "/Users/adamking/claude-code-projects/ak-site/src/pages/forms/forgot.astro";
const $$url = "/forms/forgot";

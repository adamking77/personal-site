...
All variants
` })} </div> <div class="flex flex-col divide-y divide-zinc-200 dark:divide-white/10 mt-8"> <!-- Primary Variant --> <div class="py-4 flex flex-wrap items-center gap-4"> ${renderComponent($$result3, "Button", $$Button, { "size": "small", "variant": "primary" }, { "default": ($$result4) => renderTemplate`Primary small` })} ${renderComponent($$result3, "Button", $$Button, { "size": "medium", "variant": "primary" }, { "default": ($$result4) => renderTemplate`Primary medium` })} </div> <!-- Secondary Variant --> <div class="py-4 flex flex-wrap items-center gap-4"> ${renderComponent($$result3, "Button", $$Button, { "size": "small", "variant": "secondary" }, { "default": ($$result4) => renderTemplate`Secondary small` })} ${renderComponent($$result3, "Button", $$Button, { "size": "medium", "variant": "secondary" }, { "default": ($$result4) => renderTemplate`Medium secondary` })} </div> </div> ` })} </section> ` })}`;
}, "/Users/adamking/claude-code-projects/ak-site/src/pages/system/buttons.astro", void 0);

const $$file = "/Users/adamking/claude-code-projects/ak-site/src/pages/system/buttons.astro";

...
const $$Button = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Button;
  const { size, variant, gapSize, class: className, ...rest } = Astro2.props;
...
}, "/Users/adamking/claude-code-projects/ak-site/src/components/fundations/elements/Button.astro", void 0);
